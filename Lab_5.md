...
![image](https://user-images.githubusercontent.com/103726508/205319701-0b8d8457-c1c8-4c4a-a093-acd87380ad51.png)

Вот такие графики вывелись в TensorBoard:

![image](https://user-images.githubusercontent.com/103726508/205319955-4e80dc89-4d37-49e3-93b6-e35df011b1b6.png)
...
![image](https://user-images.githubusercontent.com/103726508/205320330-75d3e4b1-4bc9-4880-b72e-5b33b353e1b2.png)
![image](https://user-images.githubusercontent.com/103726508/205320508-b72c44b3-6a09-4dc2-8e0a-ac2d79884046.png)
...
Графики в разделе Policy показывают изменение некоторых параметров, которые указаны в .yaml файле:
 ...
 - График Entropy: Показывает насколько случайны решения модели. Должен медленно уменьшаться во время успешного тренировочного процесса. Уменьшается при второй попытке, в остальных - увеличивается. 

 - График Epsilon: имеют разные значения (мы их задавали сами).

 - График Extrinsic Reward: Этот график соответствует среднему совокупному вознаграждению, полученному от окружающей среды за эпизод. 
 ...
 - График Learning Rate: все пять графиков одинаково идут вниз .


## Выводы
В этой лабораторной я поняла, что усли менять параметры в .yaml файле, то и обучение будет идти по разному. В моём случае самой успешной тренировкой оказалась самая первая.
