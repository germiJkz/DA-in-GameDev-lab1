...
Были проведены наблюдения значений TotakError по 5 раз для каждой из 8 эпох для кадждой операции. Результаты записаны в таблицу:
| OR | 1 попытка | 2 попытка | 3 попытка | 4 попытка |5 попытка | Среднее значение |
|-----|---|---|---|---|---|-----|
| 1 эпоха | 2 | 2 | 3 | 2 | 2 | 2.2 |
| 2 эпоха | 1 | 1 | 2 | 2 | 1 | 1.4 |
| 3 эпоха | 1 | 0 | 0 | 2 | 1 | 0.8 |
| 4 эпоха | 0 | 0 | 0 | 0 | 1 | 0.2 |
| 5 эпоха | 0 | 0 | 0 | 0 | 0 | 0 |
| 6 эпоха | 0 | 0 | 0 | 0 | 0 | 0 |
| 7 эпоха | 0 | 0 | 0 | 0 | 0 | 0 |
| 8 эпоха | 0 | 0 | 0 | 0 | 0 | 0 |
...
Из средних значений таблицы вышк=е были построены графики:

![image](https://user-images.githubusercontent.com/103726508/204829949-467b4223-2e96-48fe-a36c-02565a2aef8d.png)
