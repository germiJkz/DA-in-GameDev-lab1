...
Были проведены наблюдения значений TotakError по 5 раз для каждой из 8 эпох для кадждой операции. Результаты записаны в таблицы:
...
| 5 эпоха | 0 | 0 | 0 | 0 | 0 | 0.0 |
| 6 эпоха | 0 | 0 | 0 | 0 | 0 | 0.0 |
| 7 эпоха | 0 | 0 | 0 | 0 | 0 | 0.0 |
| 8 эпоха | 0 | 0 | 0 | 0 | 0 | 0.0 |

| AND| 1 попытка | 2 попытка | 3 попытка | 4 попытка |5 попытка | Среднее значение |
|-----|---|---|---|---|---|-----|
| 1 эпоха | 1 | 2 | 1 | 1 | 2 | 1.4 |
| 2 эпоха | 1 | 3 | 3 | 2 | 2 | 2.2 |
| 3 эпоха | 3 | 3 | 3 | 2 | 3 | 2.8 |
| 4 эпоха | 0 | 3 | 3 | 2 | 0 | 1.6 |
| 5 эпоха | 1 | 1 | 1 | 1 | 3 | 1.4 |
| 6 эпоха | 1 | 1 | 2 | 0 | 1 | 1.0 |
| 7 эпоха | 0 | 1 | 0 | 1 | 0 | 0.4 |
| 8 эпоха | 0 | 0 | 0 | 0 | 0 | 0.0 |

| NAND | 1 попытка | 2 попытка | 3 попытка | 4 попытка |5 попытка | Среднее значение |
|-----|---|---|---|---|---|-----|
| 1 эпоха | 1 | 2 | 1 | 1 | 2 | 1.4 |
| 2 эпоха | 3 | 3 | 3 | 3 | 2 | 2.8 |
| 3 эпоха | 2 | 2 | 3 | 1 | 2 | 2.0 |
| 4 эпоха | 2 | 3 | 2 | 0 | 3 | 2.0 |
| 5 эпоха | 1 | 1 | 3 | 0 | 0 | 1.0 |
| 6 эпоха | 0 | 0 | 1 | 0 | 0 | 0.2 |
| 7 эпоха | 0 | 0 | 0 | 0 | 0 | 0.0 |
| 8 эпоха | 0 | 0 | 0 | 0 | 0 | 0.0 |

| XOR | 1 попытка | 2 попытка | 3 попытка | 4 попытка |5 попытка | Среднее значение |
|-----|---|---|---|---|---|-----|
| 1 эпоха | 2 | 3 | 2 | 2 | 4 | 2.6 |
| 2 эпоха | 4 | 3 | 3 | 2 | 2 | 2.8 |
| 3 эпоха | 4 | 2 | 2 | 2 | 2 | 2.4 |
| 4 эпоха | 2 | 2 | 2 | 1 | 3 | 2.0 |
| 5 эпоха | 4 | 4 | 3 | 4 | 4 | 3.8 |
| 6 эпоха | 4 | 4 | 4 | 4 | 4 | 4.0 |
| 7 эпоха | 4 | 4 | 4 | 4 | 4 | 4.0 |
| 8 эпоха | 4 | 4 | 4 | 4 | 4 | 4.0 |

Из средних значений таблиц выше были построены графики:

![image](https://user-images.githubusercontent.com/103726508/204829949-467b4223-2e96-48fe-a36c-02565a2aef8d.png)

Количество эпох зависит от решаемой задачи, для одной достаточно 5, для другой 7, а для каких-то и ста не хватит( нелинейные задачи как XOR).
...
## Выводы
В ходе лабораторной работы я познакомилась с алгоритмом работы перцептрона и применила его на практике. Построила соответствующие графики.
