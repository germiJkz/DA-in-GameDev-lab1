...
Я поменяла кол-во итераций на 1 000 000 и график стал более корректным (см. Рис. 15). Величина loss значительно уменьшилась. 
...
Если параметр увеличить в 10 раз(см. Рис. 16), в 100 раз(см. Рис. 17) и в 10 000 раз(см. Рис. 18), то при сравнении с изначальным значением(см. Рис. 14) отчётливо видна разница в точности работы алгоритма. 
